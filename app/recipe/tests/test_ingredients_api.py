...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_retrieve_ingredients_list(self):
        ...
        Ingredient.objects.create(user=self.user, name='Campari')
    ...
    def test_retrieve_ingredients_assigned_unique(self):
        ...
        Ingredient.objects.create(user=self.user, name='Vermouth')
        ...
        serializer1 = IngredientSerializer(ingredient)
