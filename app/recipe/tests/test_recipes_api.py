...
class PublicRecipeApiTests(TestCase):
    """Tests the publicly available (unauthenticated) recipe API"""
...
class PrivateRecipeApiTests(TestCase):
    """Tests the private (authenticated) recipe API"""
    ...
    def test_create_recipe_with_tags(self):
        ...
        tag1 = sample_tag(user=self.user, name='Cocktail')
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        ingredient1 = sample_ingredient(user=self.user, name='Gin')
    ...
    def test_partial_update_recipe(self):
        ...
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
        new_tag = sample_tag(user=self.user, name='Soft drink')
        payload = {
            'title': 'Red lemonade',
            'tags': [new_tag.id]
        }
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_bad_request(self):
        """Tests uploading an in valid image"""
        url = image_upload_url(self.recipe.id)
